...
public class CycleEntryTest {
    ...
    public void testGetName() {
        ...
        Entry instance = new Cycle("Alice", 1, 2, 2003, 0, 16, 7, 3, "asphalt", "moderate");
    ...
    public void testGetDay() {
        ...
        Entry instance = new Cycle("Alice", 1, 2, 2003, 0, 16, 7, 3, "gravel", "moderate");
        int expResult = 1;
    ...
    public void testGetMonth() {
        ...
        Entry instance = new Cycle("Alice", 1, 2, 2003, 0, 16, 7, 3, "mountain", "fast");
        int expResult = 2;
    ...
    public void testGetYear() {
        ...
        Entry instance = new Cycle("Alice", 1, 2, 2003, 0, 16, 7, 3, "gravel", "slow");
        int expResult = 2003;
    ...
    public void testGetHour() {
        ...
        Entry instance = new Cycle("Alice", 1, 2, 2003, 0, 16, 7, 3, "asphalt", "fast");
        int expResult = 0;
    ...
    public void testGetTerrain() {
        ...
        String result = ((Cycle) instance).getTerrain();
        assertEquals(expResult, result);
    }
    ...
    public void testGetTempo() {
        ...
        String result = ((Cycle) instance).getTempo();
        assertEquals(expResult, result);
    }
